...
export default function CourseSidebar({
  ...
  // ── Mobile: always render expanded, regardless of desktop collapsed state ──
  ...
  return (
    <aside
      className={`
        ...
        ${effectiveCollapsed ? 'w-16' : 'w-[250px]'}
      `}
    >
      {/* ── Header ── */}
      <div className={`flex items-center border-b border-gray-200 ${effectiveCollapsed ? 'justify-center py-4 px-2' : 'justify-between px-5 py-4'}`}>
        {!effectiveCollapsed && (
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="hidden lg:flex p-1.5 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-gray-800 transition-colors flex-none"
          ...
          {/* Mobile close (X) — only when onMobileClose is provided */}
          {onMobileClose && (
            <button
              onClick={onMobileClose}
              className="lg:hidden p-1.5 rounded-lg hover:bg-gray-100 text-gray-500 hover:text-gray-800 transition-colors flex-none"
              title="Close"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
